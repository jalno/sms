	...
	<div class="col-md-12">
		<form action="<?php echo userpanel\url('settings/sms/gateways/delete/'.$gateway->id); ?>" method="POST" role="form" class="form-horizontal">
			<div class="alert alert-block alert-warning fade in">
				...
				<p>
					<?php echo t('sms.gateway.delete.warning', ['gateway' => $gateway->id]); ?>
				</p>
				<p>
					<a href="<?php echo userpanel\url('settings/sms/gateways'); ?>" class="btn btn-light-grey"><i class="fa fa-chevron-circle-right"></i> <?php echo t('back'); ?></a>
