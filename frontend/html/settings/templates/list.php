	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-file-text-o"></i> <?php echo t('settings.sms.templates'); ?>
				<div class="panel-tools">
					<?php if ($this->canAdd) { ?>
					<a class="btn btn-xs btn-link tooltips" title="<?php echo t('add'); ?>" href="<?php echo userpanel\url('settings/sms/templates/add'); ?>"><i class="fa fa-plus"></i></a>
					<?php } ?>
...
?>
						<thead>
							<tr>
								<th class="center">#</th>
								<th><?php echo t('sms.template.name'); ?></th>
								<th><?php echo t('sms.template.lang'); ?></th>
								<th><?php echo t('sms.template.status'); ?></th>
    ...
    foreach ($this->getDataList() as $item) {
        ...
        $name = t('sms.template.name.'.$item->name);
        ?>
						<tr>
							<td class="center"><?php echo $item->id; ?></td>
							<td><?php echo $name ? $name : $item->name; ?></td>
							<td><?php echo t('translations.langs.'.$item->lang); ?></td>
...
?>
	...
	<div class="modal-footer">
		<button type="submit" form="templates_search_form" class="btn btn-success"><?php echo t('search'); ?></button>
